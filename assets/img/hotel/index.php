...
<head>
    <meta charset="UTF-8">
    <title>Trang Chủ - Khách Sạn HMS</title>
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.php"><i class="bi bi-building me-2"></i>HMS Hotel</a>
            <div class="d-flex">
    ...
    <div class="container mt-5 text-center">
        <h1 class="fw-bold text-primary mb-3">Chào mừng đến với HMS Hotel</h1>
    ...
    <footer class="bg-dark text-white text-center py-4 mt-5">
        <p class="mb-0">&copy; 2026 HMS Hotel Management System. Developed by Alex.</p>
    </footer>
